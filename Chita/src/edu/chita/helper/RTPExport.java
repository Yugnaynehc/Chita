...
/**
 * A sample program to receive RTP transmission, transcode the stream to an
 * output location with a default data format.
 */
public class RTPExport extends Thread implements ControllerListener, DataSinkListener {

	private int duration;
	private MediaLocator iml, oml;
	...
	public RTPExport(String[] args) {
		...
		//RTPExport export = new RTPExport();
	}
	...
	static void prUsage() {
		System.err
				.println("Usage: java RTPExport -o <output> -d <duration> <session> <session> ...");
		System.err.println("     <output>: output URL or file name");
		System.err.println("     <duration>: duration in seconds");
		System.err
				.println("     <session>: [SourceIP]:[SourcePort]/[ContentType]");
		return;
	}
}